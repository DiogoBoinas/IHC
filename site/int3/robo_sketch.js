...
function setup() {
    ...
    colors.on('track', function(event) {
        if (event.data.length === 0) {
            ...
            event.data.forEach(function(rect) {
                ...
                if(x_final <= windowW/2 - 20 + 100 && x_final >= windowW/2 - 20){
                    if(y_final >= 10*windowH/12 && y_final <=10*windowH/12+200){
                        selecting=true;
                        timerSelect++;
                        if (timerSelect>20){
                            interacted=true;
  ...
  espantalho=loadImage("../images/int3/robo1.png");
  espantalho2=loadImage("../images/int3/robo2.png");
  espantalho3=loadImage("../images/int3/robo3.png");
  espantalho4=loadImage("../images/int3/robo4.png");
  alfinetes=loadImage("../images/int3/heart-cursor.png");
...
function draw() {
  ...
  if (timer>100){
      ...
      push();
      tint(255,255 - fade1);
      image(espantalho4,-25+getParallaxX(20),-25+getParallaxY(20),windowW+50,windowH+50);
      if (fade1>0) fade1-=30;
      pop();
  }
